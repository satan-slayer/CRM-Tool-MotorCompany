...
def select(e):
	...
	i3.delete(0, END)
	i3.insert(0, values[3])
	i4.delete(0, END)
	i4.insert(0, values[4])
	i5.delete(0, END)
	i5.insert(0, values[5])
	i6.delete(0, END)
	i6.insert(0, values[6])
	i7.delete(0, END)
	i7.insert(0, values[7])
	i8.delete(0, END)
	i8.insert(0, values[8])

def edit():
	selected = main.selection()[0]
	y = [i0.get(), i1.get(), i2.get(), i3.get(), i4.get(), i5.get(), i6.get(), i7.get(), i8.get(),]
	main.item(selected, values=(y[0], y[1], y[2], y[3], y[4], y[5], y[6], y[7], y[8]))
	i1.delete(0, END)
	i0.delete(0, END)
	i2.delete(0, END)
	i3.delete(0, END)
...
b1 = Button(fbutton, text='Remove Record', bg='#020010', fg='silver', relief='groove', command=remove)
b2 = Button(fbutton, text='Update Record', bg='#020010', fg='silver', relief='groove', command=edit)
